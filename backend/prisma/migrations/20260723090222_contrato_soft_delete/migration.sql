...
INSERT INTO "new_Contrato" ("aprovadoPorId", "arquivoPdfUrl", "caucaoNumeroParcelas", "contratoAnteriorId", "contratoAssinadoUrl", "createdAt", "criadoPorId", "dataAprovacao", "dataFim", "dataInicio", "dataRejeicao", "diaVencimento", "id", "imovelId", "inquilinoId", "motivoRejeicao", "status", "statusAprovacao", "updatedAt", "valorAluguel", "valorCaucao") SELECT "aprovadoPorId", "arquivoPdfUrl", "caucaoNumeroParcelas", "contratoAnteriorId", "contratoAssinadoUrl", "createdAt", "criadoPorId", "dataAprovacao", "dataFim", "dataInicio", "dataRejeicao", "diaVencimento", "id", "imovelId", "inquilinoId", "motivoRejeicao", "status", "statusAprovacao", "updatedAt", "valorAluguel", "valorCaucao" FROM "Contrato";
DROP TABLE "Contrato";
