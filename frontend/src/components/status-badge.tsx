...
const ROTULOS: Record<string, string> = {
  ...
  sem_imoveis: "Sem Imóveis",
  aguardando_pagamento_inquilinos: "Aguardando Inquilinos",
  mensal: "Mensal",
...
const CORES: Record<string, string> = {
  ...
  sem_imoveis: "bg-muted text-muted-foreground",
  aguardando_pagamento_inquilinos: AMBER,
